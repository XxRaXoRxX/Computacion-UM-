...
class Main():
    ...
    def main(self):
        cons = Constants()
        self.Threading(cons = cons)

    def Threading(self, cons):
        """
        ...
        child1 = th.Thread(target = self.Child1, name = "Terminal Reader", args = (child1_conn, fn, cons))
        child1.start()
        #Genero el segundo hijo
        child2 = th.Thread(target = self.Child2, name = "Encripter", args = (child2_conn, cons))
        child2.start()
    ...
    def Child1(self, pipe, fn, cons):
        ...
        for str in sys.stdin:
            ...
            # Recibo del queue y printeo
            self.Child1_Print(cons = cons)

    def Child2(self, pipe, cons):
    ...
    def Child1_Print(self, cons):
        """Printar en pantalla el archivo encriptado.
        
        args:
                -cons: Constantes"""

        print(f"{cons.PRINT} {self.q.get()}\n")
